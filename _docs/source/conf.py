# -*- coding: utf-8 -*-
#
# VIAM documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'VIAM.tex', u'VIAM Documentation',
     u'Gaudenz Halter', 'manual'),
]
...
man_pages = [
    (master_doc, 'viam', u'VIAM Documentation',
     [author], 1)
]
