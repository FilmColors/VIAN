...
#     def __init__(self, main_window):
#         super(Player_Qt, self).__init__(main_window=main_window)
...
#
#     def open_movie(self, path):
#         self.media = QMediaContent(QtCore.QUrl.fromLocalFile(path))
#         self.media_player.setMedia(self.media)
#         cap = cv2.VideoCapture(path)
#         self.video_size = (cap.get(cv2.CAP_PROP_FRAME_WIDTH), cap.get(cv2.CAP_PROP_FRAME_HEIGHT))
...
#
#     def set_mute(self, mute):
#         self.media_player.setMuted(mute)
#
#     def get_mute(self):
#         return self.media_player.isMuted()
#
#     def get_source_width(self):
...
#     def frame_step(self, backward = False):
#         if backward:
#             self.set_media_time(self.get_media_time() - (1000 / self.fps))
#         else:
#             self.set_media_time(self.get_media_time() + (1000 / self.fps))
#
#     def get_fps(self):
...
#
#     def on_loaded(self, project):
#         self.open_movie(project.movie_descriptor.get_movie_path())
#
#     def on_changed(self, project, item):
#         pass
#
