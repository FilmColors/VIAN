...
class AnnotationToolbar(EToolBar):
    def __init__(self, main_window, drawing_widget):
        ...
        self.action_rect.setToolTip("Create a rectangle")
        self.action_ellipse.setToolTip("Create an ellipse")
        self.action_text.setToolTip("Create a text")
        self.action_image.setToolTip("Create a image")
        self.action_freehand.setToolTip("Create a free hand")
        self.action_test.setToolTip("Create a rectangle")
