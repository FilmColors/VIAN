...
class FilmographyWidget2(QWidget):
    def __init__(self, parent, project = None, persons = None, processes = None, genres = None, countries = None, companies=None):
        ...
        self.lineEdit_IMDB = QLineEdit(self)
        lt = QHBoxLayout(self)
        lt.addWidget(QLabel("IMDB ID:", self))
        lt.addWidget(self.lineEdit_IMDB)
        self.layout().addItem(lt)

        self.lineEdit_Genre = MultiItemTextInput(self, "Genre")
        self.lineEdit_Director = MultiItemTextInput(self, "Director")
        self.lineEdit_Cinematography = MultiItemTextInput(self, "Cinematography")
        self.lineEdit_ColorConsultant = MultiItemTextInput(self, "Color Consultant")
        self.lineEdit_ProductionDesign = MultiItemTextInput(self, "Production Design")
        self.lineEdit_ArtDirector = MultiItemTextInput(self, "Art Director")
        self.lineEdit_CostumDesign = MultiItemTextInput(self, "Costume Design")

        self.lineEdit_ColorProcess = MultiItemTextInput(self, "Color Process")

        self.lineEdit_ProductionCompany = MultiItemTextInput(self, "Production Company")
        self.lineEdit_ProductionCountry = MultiItemTextInput(self, "Production Country")
