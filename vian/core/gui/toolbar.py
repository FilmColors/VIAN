...
class WidgetsToolbar(EToolBar):
    def __init__(self, main_window):
        ...
        self.a_outliner.setShortcut(QKeySequence(Qt.Key.Key_Alt + Qt.Key.Key_O))
        self.a_timeline.setShortcut(QKeySequence(Qt.Key.Key_Alt + Qt.Key.Key_T))
        self.a_player_controls.setShortcut(QKeySequence(Qt.Key.Key_Alt + Qt.Key.Key_P))
        self.a_analyses.setShortcut(QKeySequence(Qt.Key.Key_Alt + Qt.Key.Key_A))
        self.a_classification.setShortcut(QKeySequence(Qt.Key.Key_Alt + Qt.Key.Key_C))
        self.a_query.setShortcut(QKeySequence(Qt.Key.Key_Alt + Qt.Key.Key_Q))
        self.a_upload.setShortcut(QKeySequence(Qt.Key.Key_Alt + Qt.Key.Key_U))
        self.a_inspector.setShortcut(QKeySequence(Qt.Key.Key_Alt + Qt.Key.Key_I))
